...
def write_data(
    ...
    X_train.to_csv(data_path.joinpath('05_model_input/x_train.csv'))
    X_test.to_csv(data_path.joinpath('05_model_input/x_test.csv'))
    y_train.to_csv(data_path.joinpath('05_model_input/y_train.csv'))
    y_test.to_csv(data_path.joinpath('05_model_input/y_test.csv'))
